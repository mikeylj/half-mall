...
<div class="mod-commonBtn">
    <a class="mod-perCenterBtn" href="/account/index?srcFrom=SRDB-TEST-001"></a> <a
        class="mod-homePageBtn" href="/srdb_index/index?srcFrom=SRDB-TEST-001"></a>
</div>
<!-- 导航  end-->
<!-- 点击查看详情弹出框  start-->
...
<div class="outer">
    <div class="header">
        <ul class="record-header">
            <li class="rcd-h-list rcd-hl-curr">全部记录</li>
        </ul>
    </div>
    <div class="inner">
        <ul class="record-item">
            ...
            <li class="record-list" style="background-color: #FCEBEB;">
                ...
                <div class="record-lst-con">
                    <h3 class="rcd-lC-title">100元加油卡</h3>
                    <div style="position: relative;"  class="rcd-lC-middel">
                        <div class="rcd-annoce-term">
                            <p class="rcd-annoce-tNum">商品期数:ZSHK1003qo0002172265</p>
                            <a style="position: absolute; top: -.22rem;right: .01rem;color: #ff0033; background-color:#fff; border: 1px solid #FF0033;" class="rcd-annoce-tS " onclick="publishDetail('','ZSHK1003qo0002172265','8','37')">查看号码</a>
                        </div>
                        <div class="rcd-lCM-need">
                            <p class="rcd-lCM-nT">
                                <img style="margin-top: .03rem;" src="/images/ssc6.png" alt="" />结果：<span class="cr">0,0,6,9,6</span>
                            </p>
                            <p class="rcd-lCM-surplus">
                                获胜号码：<span class="cr">37</span>
                            </p>
                        </div>
                        <div class="rcd-lCM-need">
                            <p class="rcd-lCM-nT">
                        ...
                        <div class="rcd-lCM-need">
                            ...
                            <p class="rcd-lCM-surplus">
                                <span class="cr">1-55</span>
                            </p>
                        </div>
                        <p class="rcd-annoce-totle cb">( [中国]36.102.227.204)</p>
                        <p>揭晓时间： 2018-01-10 11:20:00</p>
                    </div>
                </div>
            </li>
            <li class="record-list" style="background-color: #FCEBEB;">
                ...
                <div class="record-lst-con">
                    ...
                    <div style="position: relative;"  class="rcd-lC-middel">
                        <div class="rcd-annoce-term">
                            <p class="rcd-annoce-tNum">商品期数:ZSHK1005rd0002172266</p>
                            <a style="position: absolute; top: -.22rem;right: .01rem;color: #ff0033; background-color:#fff; border: 1px solid #FF0033;" class="rcd-annoce-tS " onclick="publishDetail('','ZSHK1005rd0002172266','8','37')">查看号码</a>
                        </div>
                        <div class="rcd-lCM-need">
                            <p class="rcd-lCM-nT">
                                <img style="margin-top: .03rem;" src="/images/ssc6.png" alt="" />结果：<span class="cr">0,0,6,9,6</span>
            ...
            <li class="record-list" style="background-color: #FCEBEB;">
                ...
                <div class="record-lst-con">
                    ...
                    <div style="position: relative;"  class="rcd-lC-middel">
                        <div class="rcd-annoce-term">
                            <p class="rcd-annoce-tNum">商品期数:ZSHK1005rd0002172267</p>
                            <a style="position: absolute; top: -.22rem;right: .01rem;color: #ff0033; background-color:#fff; border: 1px solid #FF0033;" class="rcd-annoce-tS " onclick="publishDetail('','ZSHK1005rd0002172266','8','37')">查看号码</a>
                        </div>
                        <div class="rcd-lCM-need">
                            <p class="rcd-lCM-nT">
            ...
            <li class="record-list" style="background-color: #FCEBEB;">
                ...
                <div class="record-lst-con">
                    ...
                    <div style="position: relative;"  class="rcd-lC-middel">
                        <div class="rcd-annoce-term">
                            <p class="rcd-annoce-tNum">商品期数:ZSHK1005rd0002172268</p>
                            <a style="position: absolute; top: -.22rem;right: .01rem;color: #ff0033; background-color:#fff; border: 1px solid #FF0033;" class="rcd-annoce-tS " onclick="publishDetail('','ZSHK1005rd0002172266','8','37')">查看号码</a>
                        </div>
                        <div class="rcd-lCM-need">
                            <p class="rcd-lCM-nT">
            ...
            <li class="record-list" style="background-color: #FCEBEB;">
                ...
                <div class="record-lst-con">
                    ...
                    <div style="position: relative;"  class="rcd-lC-middel">
                        <div class="rcd-annoce-term">
                            <p class="rcd-annoce-tNum">商品期数:ZSHK1005rd0002172269</p>
                            <a style="position: absolute; top: -.22rem;right: .01rem;color: #ff0033; background-color:#fff; border: 1px solid #FF0033;" class="rcd-annoce-tS " onclick="publishDetail('','ZSHK1005rd0002172266','8','37')">查看号码</a>
                        </div>
                        <div class="rcd-lCM-need">
                            <p class="rcd-lCM-nT">
        ...
        <p id="mores"
           style="text-align: center; height: .4rem; line-height: .4rem; font-size: .14rem;">
            <a onclick="runs(6280361,174164)">点击加载更多...</a>
        </p>
