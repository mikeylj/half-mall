    ...
    <div class="inner">
        <ul class="record-item">
                ...
                <div class="record-lst-con">
                    ...
                    <div style="position: relative;"  class="rcd-lC-middel">
                        <div class="rcd-annoce-term">
                            <p class="rcd-annoce-tNum">商品期数:ZSHK100if10002172850</p>
                            <a style="position: absolute; top: -.22rem;right: .01rem;color: #ff0033; background-color:#fff; border: 1px solid #FF0033;" class="rcd-annoce-tS " onclick="publishDetail('','ZSHK100if10002172850','8','59')">查看号码</a>
                        </div>
                        <div class="rcd-lCM-need">
                            <p class="rcd-lCM-nT">
                                <img style="margin-top: .03rem;" src="/images/ssc6.png" alt="" />结果：<span class="cr">9,2,2,3,8</span>
                            </p>
                            <p class="rcd-lCM-surplus">
                                获胜号码：<span class="cr">59</span>
                            </p>
                        </div>
                        <div class="rcd-lCM-need">
                            <p class="rcd-lCM-nT">
                        ...
                        <p class="rcd-annoce-totle cb">([广东省深圳市]223.104.1.112)</p>
                        <p>揭晓时间：2018-01-10 14:20:00</p>
                    </div>
                </div>
            </li>
            <li class="record-list" style="background-color: #F7F7F7;">
                ...
                <div class="record-lst-con">
                    ...
                    <div style="position: relative;"  class="rcd-lC-middel">
                        <div class="rcd-annoce-term">
                            <p class="rcd-annoce-tNum">商品期数:ZSHK100if10002172851</p>
                            <a style="position: absolute; top: -.22rem;right: .01rem;color: #ff0033; background-color:#fff; border: 1px solid #FF0033;" class="rcd-annoce-tS " onclick="publishDetail('','ZSHK100if10002172850','8','59')">查看号码</a>
                        </div>
                        <div class="rcd-lCM-need">
                            <p class="rcd-lCM-nT">
            ...
            <li class="record-list" style="background-color: #F7F7F7;">
                ...
                <div class="record-lst-con">
                    ...
                    <div style="position: relative;"  class="rcd-lC-middel">
                        <div class="rcd-annoce-term">
                            <p class="rcd-annoce-tNum">商品期数:ZSHK100if10002172852</p>
                            <a style="position: absolute; top: -.22rem;right: .01rem;color: #ff0033; background-color:#fff; border: 1px solid #FF0033;" class="rcd-annoce-tS " onclick="publishDetail('','ZSHK100if10002172850','8','59')">查看号码</a>
                        </div>
                        <div class="rcd-lCM-need">
                            <p class="rcd-lCM-nT">
            ...
            <li class="record-list" style="background-color: #F7F7F7;">
                ...
                <div class="record-lst-con">
                    ...
                    <div style="position: relative;"  class="rcd-lC-middel">
                        <div class="rcd-annoce-term">
                            <p class="rcd-annoce-tNum">商品期数:ZSHK100if10002172853</p>
                            <a style="position: absolute; top: -.22rem;right: .01rem;color: #ff0033; background-color:#fff; border: 1px solid #FF0033;" class="rcd-annoce-tS " onclick="publishDetail('','ZSHK100if10002172850','8','59')">查看号码</a>
                        </div>
                        <div class="rcd-lCM-need">
                            <p class="rcd-lCM-nT">
            ...
            <li class="record-list" style="background-color: #F7F7F7;">
                ...
                <div class="record-lst-con">
                    ...
                    <div style="position: relative;"  class="rcd-lC-middel">
                        <div class="rcd-annoce-term">
                            <p class="rcd-annoce-tNum">商品期数:ZSHK100if10002172854</p>
                            <a style="position: absolute; top: -.22rem;right: .01rem;color: #ff0033; background-color:#fff; border: 1px solid #FF0033;" class="rcd-annoce-tS " onclick="publishDetail('','ZSHK100if10002172850','8','59')">查看号码</a>
                        </div>
                        <div class="rcd-lCM-need">
                            <p class="rcd-lCM-nT">
        ...
        <p id="mores"
           style="text-align: center; height: .4rem; line-height: .4rem; font-size: .14rem;">
            <a onclick="runs(6282290,174164)">点击加载更多...</a>
        </p>
